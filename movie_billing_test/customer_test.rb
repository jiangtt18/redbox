...
def _test_calc_price_when_has_rent()
  ...
  customer.calc_price(movie_details, name, days_rented)==4
...
def _test_add_rental_when_has_one_rental()
  ...
  customer.total_price == 1 && customer.rentals.include?('Get Out') && customer.frequent_renter_points == 1
end
...
def _test_add_rental_when_have_two_rentals()
  ...
  customer.total_price == 12 && customer.rentals.include?('Get Out') && customer.rentals.include?('Bird Man')&& customer.frequent_renter_points == 2
end
